...
-- =====================================================
-- TABLA: fases
-- Descripción: Las 5 fases principales de la auditoría
-- =====================================================
CREATE TABLE fases (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
-- Insertar las 4 fases principales
INSERT INTO fases (numero_fase, nombre, descripcion, orden_visualizacion) VALUES
(1, 'Preparación Inicial', 'Establecer bases sólidas, accesos y alineación con cliente', 1),
(2, 'Keyword Research', 'Investigación y análisis de palabras clave', 2),
(3, 'Arquitectura del Sitio', 'Análisis y propuesta de arquitectura web', 3),
(4, 'Recopilación de Datos', 'Análisis técnico completo del sitio web', 4);
