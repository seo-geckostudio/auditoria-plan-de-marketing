...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            ...
            <p class="mb-0 text-muted">Registra la información de un nuevo cliente</p>
        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="url" 
                                           class="form-control <?= isset($errores['sitio_web']) ? 'is-invalid' : '' ?>" 
                                           id="sitio_web" 
                                           name="sitio_web" 
                                           value="<?= htmlspecialchars($datos_formulario['sitio_web'] ?? '') ?>"
                                           maxlength="500"
                                           placeholder="https://www.ejemplo.com">
                                    <?php if (isset($errores['sitio_web'])): ?>
                                        <div class="invalid-feedback">
                                            <?= htmlspecialchars($errores['sitio_web']) ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select <?= isset($errores['activo']) ? 'is-invalid' : '' ?>" 
                                            id="activo" 
                                            name="activo">
                                        <option value="1" <?= ($datos_formulario['activo'] ?? '1') === '1' ? 'selected' : '' ?>>Activo</option>
                                        <option value="0" <?= ($datos_formulario['activo'] ?? '1') === '0' ? 'selected' : '' ?>>Inactivo</option>
                                    </select>
                                    <div class="form-text">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="small mb-3">
                        <li><strong>Nombre de la Empresa:</strong> Requerido para identificar al cliente</li>
                    </ul>
                    
                    <h6 class="text-primary">Consejos</h6>
                    <ul class="small mb-3">
                        <li>Completa toda la información disponible para un mejor seguimiento</li>
                        <li>El sitio web principal será usado para las auditorías SEO</li>
                        <li>La información de contacto facilitará la comunicación</li>
                        <li>Las notas pueden incluir objetivos específicos o características especiales</li>
                    </ul>
                    
                    <h6 class="text-primary">Después de Crear</h6>
                    <ul class="small mb-0">
                        <li>Podrás editar la información en cualquier momento</li>
                        <li>El cliente aparecerá en la lista de clientes disponibles</li>
                        <li>Podrás crear auditorías SEO para este cliente</li>
                    </ul>
                </div>
            </div>
        </div>
